        ...
        <Table>
          <TableHeader>
            <TableRow className="border-[#30363d] hover:bg-transparent">
              ...
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider hidden sm:table-cell">Exchange</TableHead>
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider hidden sm:table-cell">Buy Date</TableHead>
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider text-right">Qty</TableHead>
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider text-right hidden sm:table-cell">Avg Cost</TableHead>
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider text-right">Current</TableHead>
              <TableHead className="text-[#8b949e] text-[11px] uppercase tracking-wider text-right hidden sm:table-cell">Invested</TableHead>
          ...
          <TableBody>
            {holdings.map(h => (
              <TableRow key={h.id} className="border-[#21262d] hover:bg-[#1c2128]">
                ...
                <TableCell className="text-[#8b949e] text-sm hidden sm:table-cell">
                ...
                <TableCell className="text-right text-[#e6edf3] font-mono hidden sm:table-cell">{fmt(h.buy_price)}</TableCell>
                <TableCell className="text-right text-[#e6edf3] font-mono">{fmt(h.live_price)}</TableCell>
                <TableCell className="text-right text-[#8b949e] font-mono hidden sm:table-cell">{fmt(h.invested)}</TableCell>
